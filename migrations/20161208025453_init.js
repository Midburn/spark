exports.up = function (knex, Promise) {
    ...
    knex.schema.createTable('users', function (table) {
        ...
        table.timestamp('reset_password_expires').defaultTo(null);
        table.string('email_validation_token', 32).unique();
        table.timestamp('email_validation_expires').defaultTo(null);
    ...
    knex.schema.createTable('payments', function (table) {
        ...
        table.boolean('payed').defaultsTo(false);
    ...
    knex.schema.createTable('npo_members', function(table) {
        ...
        table.enu('membership_status', ['not_member', 'request_approved', 'member_paid', 'member_should_pay', 'banned', 'request_rejected',     'applied_for_membership']).defaultsTo('not_member');
        table.timestamp('application_date').defaultsTo(null);
