...
const gate_status = [{id: 'regular', default: true}, {id: 'early_arrival'}];
...
const default_event = process.env.NODE_ENV === 'testing'
  ? 'MIDBURN2019'
  : `MIDBURN${new Date ().getFullYear ()}`;
module.exports = {
  // -- system constant --
  ...
  /**
     ...
     */
  CAMP_PROTOTYPE: [
    prototype_camps.THEME_CAMP.id,
    prototype_camps.ART_INSTALLATION.id,
    prototype_camps.PROD_DEP.id,
  ],
