...
class SparkApi {
  ...
  initRouters () {
    ...
    this.router.use (
      constants.ROUTER_PREFIXES.EVENTS,
      routers.eventsRouter.router
    );
    this.router.use (
      constants.ROUTER_PREFIXES.CAMPS,
      routers.campsRouter.router
    );
    this.router.use (
      constants.ROUTER_PREFIXES.USERS,
      routers.usersRouter.router
    );
    this.router.use (
      constants.ROUTER_PREFIXES.COMMUNITIES,
      routers.communitiesRouter.router
    );
